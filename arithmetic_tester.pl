...
mult(number(_),number(_)).
negate(number(_)).

%Procedure makeTest takes:
...
makeTest(_,number(0)).
makeTest(MaxDepth, plus(E1,E2)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTest(NewDepth, E1),
    makeTest(NewDepth, E2).
makeTest(MaxDepth, minus(E1,E2)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTest(NewDepth, E1),
    makeTest(NewDepth, E2).
makeTest(MaxDepth, mult(E1,E2)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTest(NewDepth, E1),
    makeTest(NewDepth, E2).
makeTest(MaxDepth, negate(E)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTest(NewDepth, E).

% Procedure makeTestWithNums takes:
% 1.) The maximum depth of an AST, not including the
%     leaves
...
makeTestWithNums(MaxDepth, List, plus(E1,E2)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTestWithNums(NewDepth, List, E1),
    makeTestWithNums(NewDepth, List, E2).
makeTestWithNums(MaxDepth, List, minus(E1,E2)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTestWithNums(NewDepth, List, E1),
    makeTestWithNums(NewDepth, List, E2).
makeTestWithNums(MaxDepth, List, mult(E1,E2)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTestWithNums(NewDepth, List, E1),
    makeTestWithNums(NewDepth, List, E2).
makeTestWithNums(MaxDepth, List, negate(E)):-
    MaxDepth > 0,
    NewDepth is MaxDepth - 1,
    makeTestWithNums(NewDepth, List, E).
